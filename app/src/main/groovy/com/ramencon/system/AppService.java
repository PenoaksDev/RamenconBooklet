...
public class AppService extends Service implements ContextReference, AppState.Listener
{
	...
	public void onCreate()
	{
		...
		AppState.getInstance().addListener( AppState.ListenerLevel.NORMAL, this );
	}
	...
	public void onPersistenceEvent( AppStateEvent event )
	{
		...
		{
			Toast.makeText( this, "Ramencon App Error: " + event.getMessage(), Toast.LENGTH_SHORT ).show();
