...
public class GuestAdapter extends BaseExpandableListAdapter
{
	...
	public View getChildView( final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent )
	{
		...
		else
		{
			...
			ImageCache.cacheRemoteImage( "guest-" + guest.id, ImageCache.REMOTE_IMAGES_URL + "images/guests/" + group.id + "/" + guest.image, false, new ImageCache.ImageResolveTask.ImageFoundListener()
			{
				@Override
