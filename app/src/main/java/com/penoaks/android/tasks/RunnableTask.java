...
public abstract class RunnableTask implements Runnable
{
	...
	public RunnableTask( TaskManager mgr )
	{
		this.mgr = mgr;
	}
	...
	{
		checkState();
		return setupId( mgr.runTask( creator, this ) );
	}
	...
	{
		checkState();
		return setupId( mgr.runTaskAsynchronously( creator, this ) );
	}
	...
	{
		checkState();
		return setupId( mgr.runTaskLater( creator, delay, this ) );
	}
	...
	{
		checkState();
		return setupId( mgr.runTaskLaterAsynchronously( creator, delay, this ) );
	}
	...
	{
		checkState();
		return setupId( mgr.runTaskTimer( creator, delay, period, this ) );
	}
	...
	{
		checkState();
		return setupId( mgr.runTaskTimerAsynchronously( creator, delay, period, this ) );
	}
