			...
			private Bundle toBundle( List<Pair<String, Object>> values ) throws IOException
			{
				...
				for ( Pair<String, Object> entry : values )
				{
					...
					else if ( value instanceof List )
					{
						...
						if ( Lists.isOfType( objectValues, String.class ) )
							bundle.putStringArrayList( key, ( ArrayList<String> ) objectValues );
						else if ( Lists.isOfType( objectValues, Integer.class ) )
							bundle.putIntegerArrayList( key, ( ArrayList<Integer> ) objectValues );
						/* else if ( Lists.isOfType( objectValues, Long.class ) )
							bundle.putLongArray( key, ( ( ArrayList<Long> ) objectValues ).toArray( new Long[0] ) );
						else if ( Lists.isOfType( objectValues, Double.class ) )
							bundle.putDoubleArray( key, ( ( ArrayList<Double> ) objectValues ).toArray( new Double[0] ) ); */
						else if ( Lists.isOfType( objectValues, Parcelable.class ) )
							bundle.putParcelableArrayList( key, ( ArrayList<Parcelable> ) objectValues );
						else if ( Lists.isOfType( objectValues, Pair.class ) )
							bundle.putParcelable( key, toBundle( ( List<Pair<String, Object>> ) objectValues ) );
						else
							throw new IOException( "Unparcelable list value: " + key + ", " + value );
					}
					else
					{
