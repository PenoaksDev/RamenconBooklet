 ...
 */
public interface ConfigurationSection extends ChecksumObject
{
	/**
	 ...
	 *
	 * @param deep Whether or not to config a deep list, as opposed to a shallow list.
	 ...
	 *
	 * @param path Path of the Object to config.
	 ...
	 *
	 * @param path Path of the String to config.
	 ...
	 *
	 * @param path Path of the int to config.
	 ...
	 *
	 * @param path Path of the boolean to config.
	 ...
	 *
	 * @param path Path of the double to config.
	 ...
	 *
	 * @param path Path of the long to config.
	 ...
	 *
	 * @param path Path of the List to config.
	 ...
	 *
	 * @param path Path of the Color to config.
	 ...
	 *
	 * @param path   Path of the ConfigurationSection to config.
